...
import com.learnnow.admin.api.dto.ImportCourseRequest;
import com.learnnow.admin.api.dto.ImportResultDto;
...
public class CourseImportServiceTest {
    ...
    public void testConflictValidationAndStrategyExecution() {
        ...
        com.learnnow.admin.api.dto.ImportValidationResultDto validation = authoringService.validateImportConflicts(duplicateReq);
